...
urlpatterns = [
    ...
    re_path(r'^popular/$', views.popular_list, name='price_filter_by_popular'),
    re_path(r'^fandoms/(?P<fandom_slug>[-\w]+)/$', views.fandom_list, name='price_filter_by_fandom'),
    re_path(r'^(?P<category_slug>[-\w]+)/$', views.product_list, name='price_filter_by_category'),
